...
def add_training_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--base_loss_weight_start", type=float, default=1.0, help="Starting weight for the base reconstruction loss.")
    parser.add_argument("--base_loss_weight_peak", type=float, default=None, help="Peak weight for base loss during warmup.")
    parser.add_argument("--base_loss_weight_end", type=float, default=None, help="Final base loss weight after decay.")
    parser.add_argument("--base_loss_warmup_ratio", type=float, default=0.0, help="Fraction of steps to warm up base loss weight from start to peak.")
    parser.add_argument("--base_loss_hold_ratio", type=float, default=0.0, help="Fraction of steps to hold base loss at peak before decay.")
    parser.add_argument("--base_loss_decay", type=str, default="linear", choices=("linear", "cosine"), help="Decay type for base loss weight.")
